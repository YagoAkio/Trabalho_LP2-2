...
export default function TabelaFuncionarios(props) {
    ...
    function excluirFuncionario(funcionario){
        if(window.confirm("Deseja realmente excluir o funcionário " + funcionario.nome)){
            props.setListaDeFuncionarios(props.listaDeFuncionarios.filter(
                (item) => item.codigo !== funcionario.codigo
            ));
        }
    }
    ...
    return (
        <>
            <Container>
                    ...
                    <tbody>
                        {
                            props.listaDeFuncionarios?.map((funcionario) => (
                                <tr key={funcionario.codigo}>
                                    ...
                                    <td>
                                        <Button onClick={() => editarFuncionario(funcionario)} variant="warning">
                                        ...
                                        {' '}
                                        <Button onClick={() => excluirFuncionario(funcionario)} variant="danger">
                ...
                <p>Quantidade de funcionários cadastrados: {props.listaDeFuncionarios.length}</p>
            </Container>
        </>
    );
}
